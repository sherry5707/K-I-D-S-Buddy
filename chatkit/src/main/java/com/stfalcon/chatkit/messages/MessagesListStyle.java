...
public class MessagesListStyle extends Style {
    ...
    private int incomingBubbleSingleLineDrawable;
    private int incomingBubbleMultiLineDrawable;
    ...
    static MessagesListStyle parse(Context context, AttributeSet attrs) {
        ...
        style.dateHeaderTextColor = typedArray.getColor(R.styleable.MessagesList_dateHeaderTextColor,
                style.getColor(R.color.blue_date));
        ...
        style.incomingBubbleSingleLineDrawable = typedArray.getResourceId(R.styleable.MessagesList_incomingBubbleSingleLineDrawable, -1);
        style.incomingBubbleMultiLineDrawable = typedArray.getResourceId(R.styleable.MessagesList_incomingBubbleMultiLineDrawable, -1);
    ...
    public Drawable getIncomingBubbleSingleLineDrawable() {
        if (incomingBubbleSingleLineDrawable != -1) {
            return getDrawable(incomingBubbleDrawable);
        }
    ...
    public Drawable getIncomingBubbleMultiLineDrawable() {
        if (incomingBubbleMultiLineDrawable != -1) {
            return getDrawable(incomingBubbleMultiLineDrawable);
        }
