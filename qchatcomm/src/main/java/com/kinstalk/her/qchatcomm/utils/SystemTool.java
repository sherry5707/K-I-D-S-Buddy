...
public final class SystemTool {
    ...
    public static String getUuid() {
        String uuid = Settings.Secure.getString(BaseApplication.getInstance().getContentResolver(), android.provider.Settings.Secure.ANDROID_ID);
        return uuid;
    }
    ...
    public static boolean isAudioDumpTest() {
        ...
        isAudioDumpTest = SystemPropertiesProxy.getBoolean(BaseApplication.getInstance().getApplicationContext(), propKey, false);
