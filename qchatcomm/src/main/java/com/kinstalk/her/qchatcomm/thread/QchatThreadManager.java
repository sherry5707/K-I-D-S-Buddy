...
package com.kinstalk.her.qchatcomm.thread;
...
public class QchatThreadManager {
    ...
    private static com.kinstalk.her.qchatcomm.thread.QchatThreadManager _instance;
    ...
    public synchronized static com.kinstalk.her.qchatcomm.thread.QchatThreadManager getInstance() {
        if (_instance == null) {
            _instance = new com.kinstalk.her.qchatcomm.thread.QchatThreadManager();
        }
        return _instance;
    }
