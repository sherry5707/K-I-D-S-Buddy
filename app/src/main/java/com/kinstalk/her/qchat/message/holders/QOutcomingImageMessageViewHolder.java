 ...
 */
public class QOutcomingImageMessageViewHolder
        extends MessageHolders.OutcomingImageMessageViewHolder<QchatMessage> {

    public QOutcomingImageMessageViewHolder(View itemView) {
        super(itemView);
    }
