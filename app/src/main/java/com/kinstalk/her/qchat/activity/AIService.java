...
public class AIService extends NewBaseAIService {
    ...
    public void onJsonResult(String jsonResult) {
        try {
            ...
            if (callback != null && jsonObject != null && (jsonObject instanceof JSONObject)) {
                ...
                if (service.equals("wakeup_sleep") || service.equals("wakeup_wakeup") || service.equals("wakeup_checkout")) {
    ...
    public void handleWakeupEvent(int command, String data) {
        ...
        QAILog.d(TAG,"handleWakeupEvent -> data -> " + data);
